# -*- coding: utf-8 -*-
#
# django_docutils documentation build configuration file, created by
...
.. note::
    ...
    django_docutils needs your help reporting errors, bugs and usability feedback.
    If you encounter an error, please post on the `Issue tracker`_.

.. _Issue tracker: https://github.com/tony/django_docutils/issues
"""
